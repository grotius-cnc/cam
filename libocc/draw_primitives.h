...
public:
    ...
    double get_3d_line_lenght(gp_Pnt point1, gp_Pnt point2);
    ...
    //! Autocad colors:
    Quantity_Color autocad_color(int colornr);

    //! Get arc startpoint[0], controlpoint[1], endpoint[2], alpha 1,2 in radians
    std::vector<gp_Pnt> get_cp_2d_acad_arc_points(gp_Pnt center, double radius, double alpha1, double alpha2);
    //! Get extra circle circumfence points, gp_Pnt input = 3x circle circumfence point.
    std::vector<gp_Pnt> get_cirlce_circumfence_points(gp_Pnt center, double radius, int division);
    //! Get extra arc circumfence points.
    std::vector<gp_Pnt> get_arc_circumfence_points(gp_Pnt center, double radius, double alpha1, double alpha2, int division);
    //! Get extra ellipse circumfence points.
    std::vector<gp_Pnt> get_ellipse_circumfence_points(gp_Pnt center, gp_Pnt secpoint, double alpha_start, double alpha_end, double ratio, int division);
