...
Quantity_Color draw_primitives::autocad_color(int colornr){
...
std::vector<gp_Pnt> draw_primitives::get_cp_2d_acad_arc_points(gp_Pnt center, double radius, double alpha1, double alpha2){
...
std::vector<gp_Pnt> draw_primitives::get_cirlce_circumfence_points(gp_Pnt center, double radius, int division){
...
std::vector<gp_Pnt> draw_primitives::get_arc_circumfence_points(gp_Pnt center, double radius, double alpha1, double alpha2, int division){
...
std::vector<gp_Pnt> draw_primitives::get_ellipse_circumfence_points(gp_Pnt center, gp_Pnt secpoint, double alpha_start, double alpha_end, double ratio, int division){
